	...
	do
	{
		...
		else
		{
			...
			for (int contador = 1; contador <=tamanhoSerieFibonacci; contador++)
			{
				...
				/***** somente será exibido o 1º e 2º termo da Série (que é o nº 1). **********************
				*  Enquanto o contador estiver entre '1' e '2', será exibido na tela só o valor "1"...
				* ... por conta da variável 'termoPosterior', que lhe foi atribuida o valor "1" (vide comentário 4.1).
				* Soma = 0 + 1 = 1
				* **************************************************************************************/
				if(contador > 2)
				{
